...
?>
    <div class="wrap">
        ...
        <h2 class="nav-tab-wrapper">
            <a href="?page=cf7-to-sfmc-options&tab=debug" class="nav-tab <?php echo $active_tab == 'debug' ? 'nav-tab-active' : ''; ?>">Debug</a>
            <a href="?page=cf7-to-sfmc-options&tab=settings" class="nav-tab <?php echo $active_tab == 'settings' ? 'nav-tab-active' : ''; ?>">Settings</a>
        </h2>
